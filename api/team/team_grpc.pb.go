...
type TeamClient interface {
	...
	UpdateTeamSteam(ctx context.Context, in *UpdateTeamRequest, opts ...grpc.CallOption) (Team_UpdateTeamSteamClient, error)
	// set team name
...
type TeamServer interface {
	...
	// update a team via stream
	UpdateTeamSteam(*UpdateTeamRequest, Team_UpdateTeamSteamServer) error
	// set team name
...
func (UnimplementedTeamServer) UpdateTeamSteam(*UpdateTeamRequest, Team_UpdateTeamSteamServer) error {
